...
#editForm {
    margin-left: 50px;
    box-shadow: 0 0 10px rgba(10, 117, 138, 0.5); /* Ajout de l'ombre avec la couleur spécifique */
    padding: 20px;
    border-radius: 8px;
}
#editForm label {
...
<body>
    ...
    <div class="row">
      ...
      <div class="container mt-3" id="res">
        <div class="row">
            ...
            <div class="col-md-9">
                <h1 style="color:#0A758A;text-align:center;">Modifier le Rendez-vous</h1><br><br>

                <form class="row g-3" method="post" id="editForm" action="{{ route('reservation.update', $reservation->id) }}" >
                    @csrf
                    @method('PUT')                  
                    
                    <div class="col-md-6">
                        <label class="form-label">Nom</label>
                        <input type="text" class="form-control" name="nom" value="{{ $client->nom }}" readonly disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Prénom</label>
                        <input type="text" class="form-control" name="prenom" value="{{ $client->prenom }}" readonly disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="text" class="form-control" name="email" value="{{ $client->email }}" readonly disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Téléphone</label>
                        <input type="text" class="form-control" name="telephone" value="{{ $client->telephone }}" readonly disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Date</label>
                        <input type="text" class="form-control" name="date" value="{{ $reservation->date }}" readonly disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Heure</label>
                        <input type="text" class="form-control" name="heure" value="{{ $reservation->heure }}" readonly disabled>
                    </div>
    ...
    <select class="form-select" name="status" id="status">
        <option value="en cours" @if($reservation->status == 'En cours') selected @endif>En cours</option>
        <option value="programme" @if($reservation->status == 'Programmé') selected @endif>Programmé</option>
        <option value="termine" @if($reservation->status == 'Terminé') selected @endif>Terminé</option>
    </select>
</div>
                    ...
                    <input type="submit" value="Modifier" class="btn" style="background: #0A758A;color:white">
                    </div>
                </form>
            </div>
        </div>

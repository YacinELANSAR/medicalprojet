...
<body>
    <div class="container-fluid p-0 d-flex h-100">
        <div  id="bdSidebar" class="d-flex flex-column flex-shrink-0 p-3  text-white offcanvas-md offcanvas-start" style="width: 280px;height:100%">
            ...
            <ul class="mynav nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item mb-1">
                    <a href="#" class="">
                    <svg style="fill:white" xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.--><path d="M128 0c13.3 0 24 10.7 24 24V64H296V24c0-13.3 10.7-24 24-24s24 10.7 24 24V64h40c35.3 0 64 28.7 64 64v16 48V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V192 144 128C0 92.7 28.7 64 64 64h40V24c0-13.3 10.7-24 24-24zM400 192H48V448c0 8.8 7.2 16 16 16H384c8.8 0 16-7.2 16-16V192zM329 297L217 409c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47 95-95c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"/></svg>
                        Rendez-vous
                    </a>
                </li>
  ...
  <div class="table-responsive">
    <form action="{{route('calendries.update',$calendrier->id)}}" method="post">
      @csrf
      @method('put')
      <table class="table table-borderless">
        ...
        <tbody>
          <tr>
            <td>
              <input type="date" name="jour" class="form-control" value="{{$calendrier->jour}}">
            </td>
            <td>
              <select class="form-select" name="decalage">
              <option value="décalage1">décalage 1</option>
                          <option value="décalage2">décalage2</option>
              </select>
            </td>
            <td>
              <input class="form-control" name="hdepart" type="time" value="{{$calendrier->hdepart}}" />
            </td>
            <td>
              <input class="form-control" name="hfin" type="time" value="{{$calendrier->hfin}}" />
            </td>
            <td>
              <select class="form-select" name="delaiconsultation">
          ...
          <tr>
            <td colspan="5">
              <input type="submit" value="Modifier Calendrier" class="form-control" style="background: #0A758A;color:white" />
            </td>
          </tr>
        </tbody>
      </table>

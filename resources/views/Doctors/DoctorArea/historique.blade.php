...
<body>
    ...
    <div class="row">
      <div class="col-md-9" id="res">
        <h1 style="color:#0A758A;text-align:center;">Les Rendez-vous terminé</h1>   <br><br>    
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr style="text-align:center;">
              ...
              <td>{{ $reservation->status }} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="green" class="bi bi-check2-circle" viewBox="0 0 16 16">

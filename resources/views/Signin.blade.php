                    ...
                    <form class="form-horizontal" method="POST" action="{{route('valid_login')}}">
                        ...
                        <div class="inputs-container">
                            ...
                            <div class="input-with-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" height="30" width="20" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
                            ...
                            <!-- ------2----- -->
                            <div class="input-with-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon-input" height="30" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
